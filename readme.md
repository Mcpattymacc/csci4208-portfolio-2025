...
| Lab-06 — REST Client: Quiz Game + Leaderboard (Modules + Fetch) [#10](https://github.com/Mcpattymacc/csci4208-portfolio-2025/issues/10) | `lab-06` | completed |
| Lab-07 — Browser Data Layer: Mock Document DB [#28](https://github.com/Mcpattymacc/csci4208-portfolio-2025/issues/28) | `lab-07` | completed |
...
| Project-02 — Sprint 3: Full Feature Set & Polish [#13](https://github.com/Mcpattymacc/csci4208-portfolio-2025/issues/13) | `project-02` | closed |
| Project-02 — Sprint 2: MVP Vertical Slice [#12](https://github.com/Mcpattymacc/csci4208-portfolio-2025/issues/12) | `project-02` | closed |
| Project-02 — Sprint 1: Pitch & Roadmap Proposal [#11](https://github.com/Mcpattymacc/csci4208-portfolio-2025/issues/11) | `project-02` | closed |
<!-- STATUS:END -->
